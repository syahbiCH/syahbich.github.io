...
UpdateResultsOutputCode();
document.getElementById('clothes').addEventListener('change', UpdateResultsOutputCode);
...
document.getElementById('officer').addEventListener('input', UpdateResultsOutputCode);
document.getElementById('gender').addEventListener('change', UpdateResultsOutputCode);
