...
function UpdateResultsOutputCode()
{
    ...
    const idCard = getDynamicList('evidence-type-one', 'N/A');
    const evidenceRecord = getDynamicList('evidence-type-two', 'N/A');
    const arrestRecord = getDynamicList('evidence-type-three', 'N/A');
...
document.getElementById('evidence-type-one').addEventListener('input', UpdateResultsOutputCode);
document.getElementById('evidence-type-two').addEventListener('input', UpdateResultsOutputCode);
document.getElementById('evidence-type-three').addEventListener('input', UpdateResultsOutputCode);
