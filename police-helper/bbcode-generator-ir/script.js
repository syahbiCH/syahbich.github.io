...
document.getElemenyById('weapon-firearm-desc').addEventListener('input', UpdateResultsOutputCode);
document.getElemenyById('weapon-blunt-object-desc').addEventListener('input', UpdateResultsOutputCode);
document.getElemenyById('weapon-other-desc').addEventListener('input', UpdateResultsOutputCode);
UpdateResultsOutputCode();
